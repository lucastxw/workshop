...
async function checkCredentialsFileSafety(path2, onWarn = (m) => console.warn(`anthropic-sdk: ${m}`)) {
  if (typeof process === "undefined" || process.platform === "win32")
    return;
  const fs = await import("./node_fs-3RO563AW.js");
  let resolved = path2;
  let st;
  try {
...
async function writeCredentialsFileAtomic(targetPath, data) {
  const fs = await import("./node_fs-3RO563AW.js");
  const path2 = await import("./node_path-5FHEC5YD.js");
...
var TokenCache = class {
  ...
  backgroundRefresh() {
    ...
    this.doRefresh().catch((err) => {
      ...
      (_a2 = this.onAdvisoryRefreshError) == null ? void 0 : _a2.call(this, err);
    });
  }
  /**
...
function wrapFetchWithMiddleware(fetchFn, middleware, options, client) {
  return async (url, init = {}) => {
    ...
    if (response.bodyUsed || ((_a2 = response.body) == null ? void 0 : _a2.locked)) {
...
function copyClientForHelper(client, { authToken, helper }) {
  ...
  const parentAuthExtraHeaders = (_a2 = internal._authState) == null ? void 0 : _a2.extraHeaders;
    ...
    try {
      ...
      while (!__classPrivateFieldGet(this, _WorkPoller_controller, "f").signal.aborted) {
        ...
        try {
          ...
          }, { headers: buildHeaders([(_a2 = __classPrivateFieldGet(this, _WorkPoller_requestOpts, "f")) == null ? void 0 : _a2.headers]), signal: __classPrivateFieldGet(this, _WorkPoller_controller, "f").signal });
        } catch (e) {
        ...
        try {
          await __classPrivateFieldGet(this, _WorkPoller_runnerClient, "f").beta.environments.work.ack(work.id, { environment_id: work.environment_id }, { headers: buildHeaders([(_b = __classPrivateFieldGet(this, _WorkPoller_requestOpts, "f")) == null ? void 0 : _b.headers]), signal: __classPrivateFieldGet(this, _WorkPoller_controller, "f").signal });
        } catch (e) {
        ...
        try {
          ...
          if (__classPrivateFieldGet(this, _WorkPoller_autoStop, "f")) {
            try {
              await __classPrivateFieldGet(this, _WorkPoller_runnerClient, "f").beta.environments.work.stop(work.id, { environment_id: work.environment_id }, { headers: buildHeaders([(_c = __classPrivateFieldGet(this, _WorkPoller_requestOpts, "f")) == null ? void 0 : _c.headers]) });
            } catch (e) {
              if (!isStatus(e, 409))
...
function defaultWorkerId() {
  var _a2;
  const env = (_a2 = globalThis.process) == null ? void 0 : _a2.env;
...
var AsyncQueue = class {
  ...
  next(signal) {
    ...
    if (__classPrivateFieldGet(this, _AsyncQueue_closed, "f") || (signal == null ? void 0 : signal.aborted)) {
...
function isEndTurnIdle(ev) {
  var _a2;
  return ev.type === "session.status_idle" && ((_a2 = ev.stop_reason) == null ? void 0 : _a2.type) === "end_turn";
}
  ...
  async *[(_SessionToolRunner_consumed = /* @__PURE__ */ new WeakMap(), _SessionToolRunner_controller = /* @__PURE__ */ new WeakMap(), _SessionToolRunner_detachExternal = /* @__PURE__ */ new WeakMap(), _SessionToolRunner_requestOpts = /* @__PURE__ */ new WeakMap(), _SessionToolRunner_toolByName = /* @__PURE__ */ new WeakMap(), _SessionToolRunner_logger = /* @__PURE__ */ new WeakMap(), _SessionToolRunner_seen = /* @__PURE__ */ new WeakMap(), _SessionToolRunner_answered = /* @__PURE__ */ new WeakMap(), _SessionToolRunner_results = /* @__PURE__ */ new WeakMap(), _SessionToolRunner_inFlightCount = /* @__PURE__ */ new WeakMap(), _SessionToolRunner_onIdle = /* @__PURE__ */ new WeakMap(), _SessionToolRunner_idleTimer = /* @__PURE__ */ new WeakMap(), _SessionToolRunner_instances = /* @__PURE__ */ new WeakSet(), Symbol.asyncIterator)]() {
    ...
    try {
      ...
      for (const t of this.tools) {
        try {
          await ((_a2 = t.close) == null ? void 0 : _a2.call(t));
        } catch (e) {
...
_SessionToolRunner_requestOptions = function _SessionToolRunner_requestOptions2() {
  ...
  return {
    ...
    headers: buildHeaders([helperHeader("session-tool-runner"), (_a2 = __classPrivateFieldGet(this, _SessionToolRunner_requestOpts, "f")) == null ? void 0 : _a2.headers]),
...
async function _SessionToolRunner_execute2(ev) {
  ...
  try {
    ...
    if (__classPrivateFieldGet(this, _SessionToolRunner_inFlightCount, "f") === 0)
      (_a3 = __classPrivateFieldGet(this, _SessionToolRunner_onIdle, "f")) == null ? void 0 : _a3.call(this);
  }
  ...
  const out = content.map((b) => {
    ...
    if (b.type === "search_result") {
      return {
        ...
        citations: { enabled: ((_a2 = b.citations) == null ? void 0 : _a2.enabled) ?? false }
      };
    }
...
var EnvironmentWorker = class {
  ...
  async handleItem(opts) {
    const workId = (opts == null ? void 0 : opts.workId) ?? readEnv("ANTHROPIC_WORK_ID");
    const environmentId = (opts == null ? void 0 : opts.environmentId) ?? readEnv("ANTHROPIC_ENVIRONMENT_ID");
    const sessionId = (opts == null ? void 0 : opts.sessionId) ?? readEnv("ANTHROPIC_SESSION_ID");
    const environmentKey = (opts == null ? void 0 : opts.environmentKey) ?? this.environmentKey ?? readEnv("ANTHROPIC_ENVIRONMENT_KEY");
    if (!workId) {
    ...
    await __classPrivateFieldGet(this, _EnvironmentWorker_instances, "m", _EnvironmentWorker_handleItem).call(this, work, environmentKey, (opts == null ? void 0 : opts.signal) ?? __classPrivateFieldGet(this, _EnvironmentWorker_signal, "f"));
  }
};
...
async function _EnvironmentWorker_handleItem2(work, environmentKey, externalSignal) {
  ...
  const agentToolset = await import("./node.browser-3KAMYBLL.js");
...
async function forceStop(client, work, log, requestOptions) {
  try {
    await client.beta.environments.work.stop(
      ...
      // re-stamping needed.
      { ...requestOptions, headers: buildHeaders([requestOptions == null ? void 0 : requestOptions.headers]) }
    );
  } catch (e) {
    if (!isStatus(e, 409)) {
...
async function heartbeatLoop(client, work, ctrl, logger, requestOptions) {
  ...
  const beat = async () => {
    try {
      const resp = await client.beta.environments.work.heartbeat(work.id, { environment_id: work.environment_id, expected_last_heartbeat: last }, { ...requestOptions, headers: buildHeaders([requestOptions == null ? void 0 : requestOptions.headers]), signal: ctrl.signal });
      ...
      case "content_block_delta": {
        ...
        switch (event.delta.type) {
          ...
          case "input_json_delta": {
            if (tracksToolInput(content) && ((_a2 = __classPrivateFieldGet(this, _BetaMessageStream_listeners, "f").inputJson) == null ? void 0 : _a2.length)) {
              let jsonSnapshot;
              try {
    ...
    switch (event.type) {
      case "content_block_delta": {
        ...
        switch (event.delta.type) {
          ...
          case "input_json_delta": {
            if (tracksToolInput2(content) && ((_a2 = __classPrivateFieldGet(this, _MessageStream_listeners, "f").inputJson) == null ? void 0 : _a2.length)) {
...
var BaseAnthropic = class {
  ...
  async prepareRequest(request, { url, options }) {
    ...
    if (this._authState.tokenCache && this.apiKey == null) {
      ...
      const existing = (_a2 = headers.get("anthropic-beta")) == null ? void 0 : _a2.split(",").map((s) => s.trim());
  ...
  async makeRequest(optionsInput, retriesRemaining, retryOfRequestLogID) {
    ...
    if (response instanceof globalThis.Error) {
      ...
      const hasMiddleware = this.middleware.length > 0 || !!((_c = options.middleware) == null ? void 0 : _c.length) || this.backendMiddleware().length > 0;
  ...
  async fetchWithTimeout(url, init, ms, controller, requestOptions, logCtx) {
    ...
    const allMiddleware = (requestMiddleware == null ? void 0 : requestMiddleware.length) || backendMiddleware.length ? [...this.middleware, ...requestMiddleware ?? [], ...backendMiddleware] : this.middleware;
...
var DEFAULT_BETAS = ["fallback-credit-2026-06-01"];
...
function betaRefusalFallbackMiddleware(fallbacks, options = {}) {
  ...
  return async (request, next, ctx) => {
    var _a2, _b, _c, _d;
    const [path2, query] = (((_a2 = ctx.options) == null ? void 0 : _a2.path) ?? "").split("?");
    if (fallbacks.length === 0 || ((_b = ctx.options) == null ? void 0 : _b.method) !== "post" || path2 !== "/v1/messages" || new URLSearchParams(query).get("beta") !== "true" || typeof ctx.options.body !== "object" || ctx.options.body == null) {
      return next(request);
    }
    ...
    const startIndex = (state == null ? void 0 : state.index) ?? -1;
    ...
    while (index < fallbacks.length - 1) {
      ...
      if ((message == null ? void 0 : message.type) !== "message" || message.stop_reason !== "refusal") {
        break;
      }
      index += 1;
      pin(index);
      ...
      fallbackBlocks.push({
        ...
        trigger: { type: "refusal", category: ((_c = message.stop_details) == null ? void 0 : _c.category) ?? null }
      });
      ...
      res = await next({
        ...
        body: JSON.stringify({
          ...body,
          ...entry,
          ...((_d = message.stop_details) == null ? void 0 : _d.fallback_credit_token) ? { fallback_credit_token: message.stop_details.fallback_credit_token } : void 0
        })
      });
    }
    ...
    if ((served == null ? void 0 : served.type) !== "message" || served.stop_reason === "refusal" || !Array.isArray(served.content)) {
      return res;
    }
...
function spliceFallbackStream(args) {
  ...
  if (signal == null ? void 0 : signal.aborted) {
    ...
    signal == null ? void 0 : signal.addEventListener("abort", makeAbort(controller, signal), { once: true });
  }
  ...
  const body = new ReadableStream({
    ...
    async cancel() {
      var _a2;
      controller.abort();
      await ((_a2 = iter.return) == null ? void 0 : _a2.call(iter, void 0));
    }
  });
  ...
  for (let hop = firstHop; hop < fallbacks.length; hop++) {
    ...
    yield emit("content_block_start", {
      ...
      content_block: {
        ...
        to: { model },
        trigger: { type: "refusal", category: (refusalDetails == null ? void 0 : refusalDetails.category) ?? null }
      }
    });
    ...
    switch (p == null ? void 0 : p.type) {
      ...
      case "message_delta": {
        if (p.delta.stop_reason === "refusal") {
          const details = ((_a2 = p.delta.stop_details) == null ? void 0 : _a2.type) === "refusal" ? p.delta.stop_details : null;
          if ((details == null ? void 0 : details.fallback_credit_token) && hasNext) {
          ...
          if (!(details == null ? void 0 : details.fallback_credit_token)) {
            onError({
...
function applyDelta(blocks, index, delta) {
  var _a2;
  const block = (_a2 = blocks.find((x) => x.index === index)) == null ? void 0 : _a2.block;
  if (!block)
    return;
  switch (delta.type) {
    case "text_delta": {
...
function toPrefillBlocks(responseBlocks) {
  return responseBlocks.map((b) => {
    if (typeof (b == null ? void 0 : b._partial_json) !== "string")
      return b;
...
function withMiddlewareHeaders(request, betas) {
  ...
  const existing = new Set((_a2 = headers.get("anthropic-beta")) == null ? void 0 : _a2.split(",").map((s) => s.trim()));
...
function toIterationUsage(type, model, u) {
  return {
    type,
    model,
    input_tokens: (u == null ? void 0 : u.input_tokens) ?? 0,
    output_tokens: (u == null ? void 0 : u.output_tokens) ?? 0,
    cache_read_input_tokens: (u == null ? void 0 : u.cache_read_input_tokens) ?? 0,
    cache_creation_input_tokens: (u == null ? void 0 : u.cache_creation_input_tokens) ?? 0,
    cache_creation: (u == null ? void 0 : u.cache_creation) ?? null
  };
}
function backfill(primary, fallback) {
  const out = { ...fallback ?? {}, ...primary ?? {} };
  for (const k of Object.keys(out)) {
    if (out[k] == null && (fallback == null ? void 0 : fallback[k]) != null)
      out[k] = fallback[k];
  }
  return out;
}
